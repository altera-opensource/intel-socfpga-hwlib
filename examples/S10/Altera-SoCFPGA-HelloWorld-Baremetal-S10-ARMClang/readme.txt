...
1. In DS, build the application:
  ...
  1b. In the "Project Explorer" panel, right-mouse-click 
      "Altera-SoCFPGA-HelloWorld-Baremetal-S10-ARMClang" and select "Build Project".
...
3. In DS, configure the launch configuration.
  ...
  3b. In the options on the left, expand "DS Debugger" and select
      "Altera-SoCFPGA-HelloWorld-Baremetal-S10-ARMClang".
...
1. In DS, launch the debug configuration.
  ...
  1b. In the "Debug Control" panel, right-mouse-click
      "Altera-SoCFPGA-HelloWorld-Baremetal-S10-ARMClang-Debug" and select
      "Connect to Target".
2. Load the examples
  2a. Run "load <path_to_Altera-SoCFPGA-HelloWorld-Baremetal-S10-ARMClang.axf>"
